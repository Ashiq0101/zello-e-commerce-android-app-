  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme: GoogleFonts.outfitTextTheme().copyWith(
        ...
        displayMedium: GoogleFonts.outfit(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 28),
        titleLarge: GoogleFonts.outfit(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 22),
        bodyLarge: GoogleFonts.outfit(color: Colors.white, fontSize: 16),
        bodyMedium: GoogleFonts.outfit(color: Colors.grey.shade400, fontSize: 14),
      ),
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          backgroundColor: primaryColor,
